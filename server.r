...
server <- function(input, output) {
  ...
  databaseChanged <- reactive({
	...
	output$nnfeInputExcludedTable <- renderDataTable({
	  idChanged()
	  windowsChanged()
	  excludeInputChanged()
	  inputDifferenceChanged()
	...
	output$nnfehInputExcludedTable <- renderDataTable({
	  idChanged()
	  windowsChanged()
	  excludeInputChanged()
	  inputDifferenceChanged()
	...
	output$nnfaInputExcludedTable <- renderDataTable({
	  idChanged()
	  windowsChanged()
	  excludeInputChanged()
	  inputStrategyChanged()
	...
	output$nnfahInputExcludedTable <- renderDataTable({
	  idChanged()
	  windowsChanged()
	  excludeInputChanged()
	  inputStrategyChanged()
